...
import math
from sign_network import Graph, get_stgcn_chain
from sign_network.deformable_attention import DeformableAttention2D
from transformers import MT5ForConditionalGeneration, T5Tokenizer 
import warnings
from settings import mt5_path
...
class SmartSignModel(nn.Module):
    def __init__(self, args):
        super(SmartSignModel, self).__init__()
        self.args = args
