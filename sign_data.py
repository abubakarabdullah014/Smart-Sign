...
from settings import rgb_dirs, pose_dirs
...
class SignDataset(Base_Dataset):
...
class SignNewsDataset(Base_Dataset):
    def __init__(self, path, args, phase):
        super(SignNewsDataset, self).__init__()
        self.args = args
        self.rgb_support = self.args.rgb_support
        self.phase = phase
        self.max_length = args.max_length
...
class SignOnlineDataset(Base_Dataset):
    def __init__(self, args):
        super(SignOnlineDataset, self).__init__()
        self.args = args
        self.rgb_support = self.args.rgb_support
        self.max_length = args.max_length
