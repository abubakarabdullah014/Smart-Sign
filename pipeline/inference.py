...
from sign_model import SmartSignModel
import sign_utils as sign_utils
from sign_data import SignOnlineDataset
...
def main(args):
    ...
    online_data = SignOnlineDataset(args=args)
    print(online_data)
...
def inference(data_loader, model):
    ...
    metric_logger = sign_utils.MetricLogger(delimiter="  ")
    header = 'Test:'
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Smart Sign inference', parents=[sign_utils.get_args_parser()])
